...
import edu.uoc.b2.tema4.ex02.ConsultasSQL;

/**
 * Tests per als exercicis JDBC / Tests para los ejercicios JDBC — Tema 4, Ex 02
 * REQUIERE tener un servidor MySQL local y una BBDD 'uoc_test'.
 */
@DisplayName("Tema 4 — Exercici 02 JDBC (MySQL)")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class Exercici02ConsultasSQLTest {
    ...
    void setUp() throws Exception {
        ...
        // Leer y ejecutar schema_ex02.sql
        try (java.io.InputStream is = getClass().getResourceAsStream("/schema_ex02.sql")) {
            if (is == null)
                throw new RuntimeException("No se encuentra schema_ex02.sql");
    ...
    @Test
    @Order(1)
    @DisplayName("Ex1: noms/nombres cliente ordenats/ordenados alfabèticament/alfabéticamente")
    ...
    @Test
    @Order(2)
    @DisplayName("Ex1: total productes/productos = 7")
    ...
    @Test
    @Order(3)
    @DisplayName("Ex2: productes/productos de Electronica (4 en total)")
    ...
    @Test
    @Order(4)
    @DisplayName("Ex2: top 3 productes/productos")
    ...
    @Test
    @Order(5)
    @DisplayName("Ex2: clients/clientes VIP d'Espanya/de España")
    ...
    @Test
    @Order(6)
    @DisplayName("Ex3: comandes/pedidos por/per client/cliente (inclou Jordi amb 0)")
    ...
    @Test
    @Order(7)
    @DisplayName("Ex3: total facturat/facturado Ana (comandes lliurades / pedidos entregados)")
    ...
    @Test
    @Order(8)
    @DisplayName("Ex3: client/cliente sense comandes lliurades / sin pedidos entregados → 0.0")
    ...
    @Test
    @Order(9)
    @DisplayName("Ex4: preu mig / precio medio Electronica ≈ 364.99")
    ...
    @Test
    @Order(10)
    @DisplayName("Ex4: categories/categorías amb/con més de 2 productes/productos → Electronica")
    ...
    @Test
    @Order(11)
    @DisplayName("Ex5: productes/productos no demanats/demandados (Cadira, Teclat, Llum LED no demanats de primeres)")
    ...
    @Test
    @Order(12)
    @DisplayName("Ex5: SELF JOIN empleat/empleado → cap/jefe")
